...
btn.addEventListener ('click', function (){
     ...
     alert('For Step 1 please go to Console!!!')
...
function sayThree(item){
    console.log(item + " is divided by three ");
}
function sayFive(item){
    console.log(item + " is divided by five");
}

threeAndFive(10,15,sayThree,sayFive);
...
let restulDoLoop = repeatStringNumTimes ('abc', 3);
console.log('Q1.5:- This is do loop: ' + restulDoLoop);
